 ...
 */
final class Version20200116125014 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(100) NOT NULL, type_event VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, date_event DATETIME NOT NULL, status VARCHAR(50) NOT NULL, painfulness SMALLINT NOT NULL, duration SMALLINT NOT NULL, societal_impact SMALLINT NOT NULL, environmental_impact SMALLINT NOT NULL, user_min SMALLINT NOT NULL, user_max SMALLINT NOT NULL, bonus SMALLINT DEFAULT NULL, adress LONGTEXT DEFAULT NULL, latitude NUMERIC(10, 8) NOT NULL, longitude NUMERIC(11, 8) NOT NULL, INDEX IDX_3BAE0AA7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
