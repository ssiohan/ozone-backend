 ...
 */
final class Version20200130130755 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD image VARCHAR(255) DEFAULT NULL, DROP cover_image, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE bonus bonus SMALLINT DEFAULT NULL, CHANGE adress adress VARCHAR(150) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD cover_image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, DROP image, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE bonus bonus SMALLINT DEFAULT NULL, CHANGE adress adress VARCHAR(150) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
